...
void test_serialise_request_to_correct_packet(void)
{
    ...
    TEST_ASSERT_EQUAL(test_frame.can_id, Packet_Priority::CAN_PRIORITY_SET_BRAKE);
...
void test_notification_sent_on_request_packet_receive(void)
{
    ...
    Subject<Set_Light_Packet> *subject = interface->get_set_brake_subject();
